...
class TestVarlociraptor:
    ...
    def test_varlociraptor_initialization(self, mock_check):
    ...
    @patch.object(Varlociraptor, '_check_installation')
    def test_varlociraptor_initialization_with_threads(self, mock_check):
    ...
    def test_estimate_alignment_properties(self, mock_run, mock_check, tmp_path):
    ...
    @patch.object(Varlociraptor, '_check_installation')
    @patch.object(Varlociraptor, 'run')
    def test_preprocess_variants(self, mock_run, mock_check, tmp_path):
    ...
    @patch.object(Varlociraptor, '_check_installation')
    @patch.object(Varlociraptor, 'run')
    def test_preprocess_variants_default_depth(self, mock_run, mock_check, tmp_path):
    ...
    def test_call_variants_generic(self, mock_file, mock_subprocess, mock_check, tmp_path):
    ...
    @patch('subprocess.run')
    @patch('builtins.open', new_callable=mock_open)
    def test_call_variants_generic_failure(self, mock_file, mock_subprocess, mock_check, tmp_path):
    ...
    def test_filter_calls_fdr_local_smart(self, mock_popen, mock_check, tmp_path):
    ...
    @patch.object(Varlociraptor, '_check_installation')
    @patch('subprocess.Popen')
    def test_filter_calls_fdr_pipeline_failure(self, mock_popen, mock_check, tmp_path):
