...
class FAIProcessor:
    def __init__(self, ueccdna=None, meccdna=None, ceccdna=None, mceccdna=None):
        """
    ...
    def get_csv_file(self, fasta_file):
        ...
        return fasta_file.replace('.fa', '.csv')
...
def main():
    ...
    parser.add_argument('-i', '--ueccdna', type=str, required=True, help='UeccDNA FASTA file path')
