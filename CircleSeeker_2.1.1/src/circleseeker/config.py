...
class Config:
    ...
    skip_report: bool = False           # alias of skip_report_generator
    ...
    @property
    def skip_report_generator(self) -> bool:
        return self.skip_report

    @skip_report_generator.setter
    def skip_report_generator(self, value: bool) -> None:
