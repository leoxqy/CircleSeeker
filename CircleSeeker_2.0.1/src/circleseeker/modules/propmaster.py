...
"""
CircleSeeker File Organizer (Propmaster)
- Collects & renames CircleSeeker outputs
...
class PropmasterOrganizer:
    """Organizes CircleSeeker output files with standardized naming."""
    ...
    def organize_files(self, 
        ...
        """
        Organize all CircleSeeker output files.
    ...
    def _write_summary(self) -> Path:
        ...
        lines = [f"CircleSeeker Organized Files - Prefix: {self.config.prefix}\n"]
