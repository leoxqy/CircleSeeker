...
class CDHitEst(ExternalTool):
    ...
    def export_id2cluster(self, cluster_file: Path, output_csv: Optional[Path] = None) -> Path:
        ...
        Args:
            ...
            output_csv: output CSV path; defaults to same prefix as .clstr
                with .id2cluster.csv extension
        Returns:
            output_csv path
        """
...
def _parse_args() -> Any:
    ...
    parser = argparse.ArgumentParser(description="CD-HIT-EST - Sequence clustering tool")
