        ...
        for old_col, new_col in LEGACY_MAPPINGS.items():
            if old_col in df.columns:
                if new_col in df.columns and old_col != new_col:
                    ...
                    warnings.warn(f"Column conflict: {old_col} maps to {new_col} but {new_col} already exists")
                    continue
                ...
                if old_col in COORDINATE_CONVERSIONS:
                    try:
                        ...
                        conversions[f"{old_col}_converted"] = f"Applied coordinate conversion"
...
SCHEMAS = {
    'uecc': [
        ColumnStandard.ECCDNA_ID, ColumnStandard.CHR, ColumnStandard.START0, 
        ColumnStandard.END0, ColumnStandard.STRAND, ColumnStandard.LENGTH,
        ColumnStandard.READS, ColumnStandard.COPY_NUMBER, ColumnStandard.MATCH_DEGREE
    ],
    'mecc': [
        ColumnStandard.ECCDNA_ID, ColumnStandard.CHR, ColumnStandard.START0,
        ColumnStandard.END0, ColumnStandard.STRAND, ColumnStandard.LENGTH, 
        ColumnStandard.READS, ColumnStandard.COPY_NUMBER, ColumnStandard.HIT_INDEX,
        ColumnStandard.HIT_COUNT
    ],
    'cecc': [
        ColumnStandard.ECCDNA_ID, ColumnStandard.CHR, ColumnStandard.START0,
        ColumnStandard.END0, ColumnStandard.STRAND, ColumnStandard.LENGTH,
        ColumnStandard.SEG_INDEX, ColumnStandard.SEG_TOTAL, ColumnStandard.JUNCTION_ROLE,
        ColumnStandard.READS, ColumnStandard.COPY_NUMBER
    ],
    'confirmed_table': [
        ColumnStandard.ECCDNA_ID, 'Regions', 'Length', ColumnStandard.ECCDNA_TYPE,
        ColumnStandard.STATE, ColumnStandard.SEG_TOTAL, ColumnStandard.HIT_COUNT
    ]
}
